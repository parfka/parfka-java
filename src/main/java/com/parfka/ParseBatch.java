...
import com.parfka.command.ParseBatchCommand;
...
public class ParseBatch {
	...
	public void deleteObject(ParfkaObject obj) {
	...
	public void createObject(ParfkaObject obj) {
		JSONObject inner = new JSONObject();
	...
	public void updateObject(ParfkaObject obj) {
		if (obj.getObjectId() == null)
