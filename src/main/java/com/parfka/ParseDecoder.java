...
import com.parfka.operation.ParseFieldOperations;
...
public class ParseDecoder {
	...
	private static ParfkaObject convertJSONObjectToParseObject(JSONObject jsonObject) {
		if (jsonObject == null) return null; 
		ParfkaObject parfkaObject = ParfkaObject.createWithoutData(jsonObject.optString("className"),
				jsonObject.optString("objectId"));
		parfkaObject.setData(jsonObject, true);
		return parfkaObject;
	}

	private static ParfkaObject decodePointer(String className, String objectId) {
	    return ParfkaObject.createWithoutData(className, objectId);
	  }	
