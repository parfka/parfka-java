...
public class ParseRelation<T extends ParfkaObject> {

	private ParfkaObject parent;
	private String key;
	...
	public ParseRelation(ParfkaObject parent, String key) {
		this.parent = parent;
		this.key = key;
	...
	void ensureParentAndKey(ParfkaObject someParent, String someKey) {
	...
	public JSONObject encodeToJSON(ParseObjectEncodingStrategy objectEncoder) throws JSONException {
		...
		for (ParfkaObject knownObject : this.knownObjects) {
			try {
